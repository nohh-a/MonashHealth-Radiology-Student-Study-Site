...
Thank you for your request to reset the password of your account on Tea Lovers Admin.

To reset your account password, use the button below to access the reset password page:
<?= $this->Url->build(['controller' => 'Auth', 'action' => 'reset_password', $nonce], ['fullBase' => true]) ?>
