                ...
                <div class="col-md-9">
                    <main class="main-content">
                        <div class="sorting">
                            <div class="sorting__inner">
                                ...
                                <div class="sorting__item">
                                    ...
                                    <div class="select jelect">
                                        <input id="sort" name="sort" value="0" data-text="imagemin" type="text"
                                               class="jelect-input">
                        ...
                        <article class="card clearfix">
                            <div class="card__img">
                                <img class="img-responsive" src="webroot/media/cards/1.jpg" height="196" width="235"
                                     alt="foto">
                            </div>
                            <div class="card__inner">
                                ...
                                <div class="card__description">
                                    <p>In a pickup market gone fancy, the Silverado sticks to its basic-truck recipe.
                                        The steering is accurate and the Silverado ...</p>
                                </div>
                        ...
                        <article class="card clearfix">
                            <div class="card__img">
                                <img class="img-responsive" src="webroot/media/cards/2.jpg" height="196" width="235"
                                     alt="foto">
                    ...
                    <aside class="sidebar">
                        <section class="widget widget_mod-a">
                            ...
                            <div class="widget-content">
                                <ul class="list-categories list-unstyled">
                                    ...
                                    <li class="list-categories__item">
                                        <a class="list-categories__link" href="javascript:void(0);">MERCEDES-BENZ
                                            (80)</a>
                                    </li>
                                    <li class="list-categories__item">
                        ...
                        <div class="wrap-filter">
                            ...
                            <section class="widget widget_mod-a">
                                ...
                                <div class="widget-content">
                                    <div class="select select_mod-a jelect">
                                        <input id="vehicle-type" name="vehicle-type" value="0" data-text="imagemin"
                            ...
                            <section class="widget widget_mod-a">
                                ...
                                <div class="widget-content">
                                    <div class="select select_mod-a jelect">
                                        <input id="fuel-type" name="fuel-type" value="0" data-text="imagemin"
                                               type="text" class="jelect-input">
                        ...
                        <div class="btn">
                            <div class="btn-filter wrap__btn-skew-r js-filter">
                                <button class="btn-skew-r btn-effect "><span
                                        class="btn-skew-r__inner">filter vehicles</span></button>
                            </div>
                        </div>
