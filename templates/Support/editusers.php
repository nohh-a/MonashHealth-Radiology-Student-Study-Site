                            ...
                            <ul class="clearfix">
                                ...
                                <?php if ($access_role === 'ADMIN') : ?>
                                    ...
                                    <div class="dropdown-container">
                                        <li class="list-padding"><a class="list-current" href="<?= $this->Url->build(['controller' => 'support', 'action' => 'editusers'])?>">Edit User</a></li>
                ...
                <div id="content_block_01">
                    <div class="content-box">
                        ...
                        <div class="text wow slideInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <li>Admins can edit user profiles to address issues or update information. To edit a user profile, follow these steps: </li>
                        </div>
                        <ul class="clearfix wow slideInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            ...
                            <br>
                            <li><strong>2. Locate specific user:</strong> From the list of users, find the user you want to edit the details of and press ‘Edit’ button.</li>
                            <br>
                            <li><strong>3. Update Details: </strong> You will be re-directed to a page to change the details of the user. Change details as desired and press the ‘Save’ button.</li>
                            <br>
                            <li><strong>4. Confirm: </strong> Pop up message saying “The user has been saved will occur”.</li>
                            <br>
                            <li>
                                You have now successfully changed a user’s details.
                            </li>
                        </ul>
                    </div>
                </div>
